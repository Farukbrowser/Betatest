...
cat <<'NUovpn' > /etc/openvpn/server.conf
 ...
 # Script Updated By Faruk Browser
NUovpn
...
# FarukBrowser VPN Premium Script
...
cd /var/www/openvpn
wget https://raw.githubusercontent.com/farukbrowser/Betatest/master/SL-Maxstream.ehi
# Kuota Whatsapp/Kemdikbud Tsel
cd /var/www/openvpn
wget https://raw.githubusercontent.com/farukbrowser/Betatest/master/SL-Wa-Kemdikbud.ehi
# Kuota Youtube Tsel
cd /var/www/openvpn
wget https://raw.githubusercontent.com/farukbrowser/Betatest/master/SL-YoutubeTsel.ehi
# zip
cd
cd /var/www/openvpn
...
echo " FarukBrowser"  | tee -a log-install.txt
echo " Facebook: https://fb.me/farukbrowser"  | tee -a log-install.txt
