...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/farukbrowser/sshsl/master/debian9/nginx-default.conf"
mkdir -p /home/vps/public_html
echo "<?php phpinfo() ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/farukbrowser/sshsl/master/debian9/vhost-nginx.conf"
...
wget -O /etc/apache2/ports.conf "https://raw.githubusercontent.com/farukbrowser/sshsl/master/debian9/apache2.conf"

# Edit port virtualhost apache2 ke 8099
wget -O /etc/apache2/sites-enabled/000-default.conf "https://raw.githubusercontent.com/farukbrowser/sshsl/master/debian9/virtualhost.conf"
...
wget -O /etc/openvpn/easy-rsa/vars "https://raw.githubusercontent.com/farukbrowser/sshsl/master/debian9/vars.conf"
...
# Restore iptables
wget -O /etc/network/if-up.d/iptables "https://raw.githubusercontent.com/farukbrowser/sshsl/master/debian9/iptables-local"
...
#wget -O usernew "https://raw.githubusercontent.com/farukbrowser/sshsl/master/debian9/usernew.sh"
