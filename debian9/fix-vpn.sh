...
# buat udp
cd /etc/openvpn/
wget -O /etc/openvpn/client-udp.ovpn "https://raw.githubusercontent.com/farukbrowser/Betatest/master/SL-udp.ovpn"
sed -i $MYIP2 /etc/openvpn/client-udp.ovpn;
cp /etc/openvpn/client-udp.ovpn /home/vps/public_html

#buat tcp
wget -O /etc/openvpn/client-tcp.ovpn "https://raw.githubusercontent.com/farukbrowser/Betatest/master/SL-tcp.ovpn"
sed -i $MYIP2 /etc/openvpn/client-tcp.ovpn;
cp /etc/openvpn/client-tcp.ovpn /home/vps/public_html/

#buat ssl
wget -O /etc/openvpn/569client-ssl.ovpn "https://raw.githubusercontent.com/farukbrowser/Betatest/master/SL-ssl.ovpn"
